...
class BaseCharacteristic:
    ...
    def read(self): ...
    def write(self, data, send_update: bool = False) -> None: ...
    @staticmethod
...
class Characteristic(BaseCharacteristic):
    ...
    def _tuple(self): ...
    def notify(self, connection, data=None) -> None: ...
    async def indicate(self, connection, data=None, timeout_ms: int = 1000) -> None: ...
    def _indicate_done(conn_handle, value_handle, status) -> None: ...

class BufferedCharacteristic(Characteristic):
    _max_len: Incomplete
    _append: Incomplete
    def __init__(self, *args, max_len: int = 20, append: bool = False, **kwargs) -> None: ...
    def _register(self, value_handle) -> None: ...
...
class Descriptor(BaseCharacteristic):
    ...
    _value_handle: Incomplete
    _initial: Incomplete
    def __init__(self, characteristic, uuid, read: bool = False, write: bool = False, initial=None) -> None: ...
    def _tuple(self): ...
