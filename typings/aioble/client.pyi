...
class ClientService:
    ...
    def characteristics(self, uuid=None, timeout_ms: int = 2000): ...
    def _start_discovery(connection, uuid=None) -> None: ...
...
class BaseClientCharacteristic:
    ...
    async def write(self, data, response=None, timeout_ms: int = 1000) -> None: ...
...
class ClientCharacteristic(BaseClientCharacteristic):
    ...
    def _start_discovery(service, uuid=None) -> None: ...
...
class ClientDescriptor(BaseClientCharacteristic):
    ...
    def __str__(self) -> str: ...
    def _connection(self): ...
    def _start_discovery(characteristic, uuid=None) -> None: ...
