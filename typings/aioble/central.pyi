...
async def _connect(connection, timeout_ms, scan_duration_ms, min_conn_interval_us, max_conn_interval_us) -> None: ...
...
class ScanResult:
    ...
    def _decode_field(self, *adv_type) -> Generator[Incomplete]: ...
    def name(self): ...
    def services(self) -> Generator[Incomplete]: ...
    def manufacturer(self, filter=None) -> Generator[Incomplete]: ...
...
class scan:
    ...
    _active: Incomplete
    def __init__(self, duration_ms, interval_us=None, window_us=None, active: bool = False) -> None: ...
