...
class Device:
    ...
    def addr_hex(self): ...
    async def connect(self, timeout_ms: int = 10000, scan_duration_ms=None, min_conn_interval_us=None, max_conn_interval_us=None): ...
...
class DeviceConnection:
    ...
    async def disconnected(self, timeout_ms=None, disconnect: bool = False) -> None: ...
    async def service(self, uuid, timeout_ms: int = 2000): ...
    def services(self, uuid=None, timeout_ms: int = 2000): ...
    async def pair(self, *args, **kwargs) -> None: ...
    def is_connected(self): ...
    def timeout(self, timeout_ms): ...
    async def exchange_mtu(self, mtu=None, timeout_ms: int = 1000): ...
